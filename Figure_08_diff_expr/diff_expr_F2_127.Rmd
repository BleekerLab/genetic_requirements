---
title: "Differential expression (F2-127, Elite and PI127826 2020 plants)"
author: "Marc Galland"
date: "10/17/2021"
output:
  pdf_document:
...
```
The density of genes woth low count values (log10 = 0.3) is lower for F2.127 but
seems to be comparable for other genes. 

## Plot log2ratio F2.127 vs Elite
...
A total of **`r nrow(log2ratio)`** have a finite log2ratio in both F2.127 vs Elite and PI127826 vs Elite. 
...
:warning: nothing significant at __p < 0.05__ so I had to "relax" the p-value threshold to __p < 0.1.__ 
...
# show table
mep_mva_gene_signif %>% 
  select(name, gene, pathway, log2ratio_P127, log2ratio_PI127826, pval_P127, pval_PI127826) %>% 
  knitr::kable()
