...
cavities <- read.csv(file = "data/20180808_Cavity volumes_14_days_treatment.csv", header = TRUE, check.names = FALSE)
...
ggsave(file = "figures/Figure_4_fosmidomycin_PI127826/fosmidomycin_PI127826_phenotypes.pdf", plot = p.both, width = 5, height = 3)
