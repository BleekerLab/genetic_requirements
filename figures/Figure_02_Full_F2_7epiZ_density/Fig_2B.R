...
df <- read.csv("data/Leafwash vs Trichome density.csv",header = TRUE, stringsAsFactors = T, check.names = FALSE)
...
# Save plot
ggsave(file = "figures/Figure_02_Full_F2_7epiZ_density/Fig_2B.pdf", plot = p.scatter, height = 5, width = 4)
